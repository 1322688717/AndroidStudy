...
public class ByWebView {
    ...
    private void handleSetting() {
        ...
        ws.setDomStorageEnabled(true); // 开启DOM
        // 排版适应屏幕
...
//        }
     ...
     * 显示错误布局
     */
    public void showErrorView(String url) {
        try {
            if (mErrorView == null) {
            ...
            TextView tvUrl=mErrorView.findViewById(R.id.error_url);
            if (tvUrl!=null){
                tvUrl.setText("位于 "+url+" 的网页无法加载" );
            }
